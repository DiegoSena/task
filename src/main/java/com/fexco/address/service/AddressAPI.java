...
public interface AddressAPI {
    ...
    @GET("/addressgeo/{country}/{query}")
    List<Address> getAddressGeos(@Path("country") String country,
                               @Path(value = "query") String query,
                               @Query("lines") String lines,
                               @Query("include") String include,
                               @Query("exclude") String exclude,
    ...
    @GET("/position/{country}/{query}")
    List<Address> getPosition(@Path("country") String country,
                                 @Path(value = "query") String query,
                                 @Query("lines") String lines,
                                 @Query("include") String include,
                                 @Query("exclude") String exclude,
